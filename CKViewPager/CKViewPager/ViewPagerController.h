...
@interface ViewPagerController : ViewController
...
/**
 * tabView width, defaults to screen with
 */
@property(nonatomic) CGFloat tabViewWidth;
/**
...
/**
 * Show UnderlineStroke
 */
@property(nonatomic) BOOL shouldUnderlineStroke;
